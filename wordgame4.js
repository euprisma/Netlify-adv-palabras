...
async function create_game_ui(mode = null, player1 = null, player2 = null, difficulty = null, gameType = null, sessionId = null) {
    ...
    // End of try block for create_game_ui
} catch (err) {
    console.error('create_game_ui: Error during UI creation', err);
} finally {
    isCreatingUI = false;
