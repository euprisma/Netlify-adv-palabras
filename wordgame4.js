...
async function create_game_ui(mode = null, player1 = null, player2 = null, difficulty = null, gameType = null, sessionId = null) {
    ...
    try {
        ...
        if (mode && player1 && (mode !== '3' || difficulty) && (mode !== '2' || gameType)) {
            console.log('create_game_ui: Using provided parameters', {
                mode,
                player1,
                player2,
                difficulty,
                ...
                if (value === 'crear') {
                    ...
                    try {
                        ...
                        if (typeof selected_mode !== 'string' || typeof selected_gameType !== 'string') {
                            console.error('Invalid mode or gameType:', {
                                selected_mode,
                                selected_gameType
                            });
                        ...
                        while (attempts--) {
                            try {
                                ...
                                const initialState = {
                                    ...
                                    tries: {
                                        init: null
                                    }, // Placeholder to ensure object persistence
                                    scores: {
                                        init: null
                                    }, // Placeholder to ensure object persistence
                                ...
                                while (validationAttempts--) {
                                    ...
                                    console.log('create_game_ui: Retrieved state after set', {
                                        sessionId: selected_sessionId,
                                        createdState
                                    });
                                ...
                                console.log('create_game_ui: Firebase session created', {
                                    sessionId: selected_sessionId,
                                    secretWord,
                                    createdState
                                });
